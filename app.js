...
const DAY_NAMES = ['周一·蹲（下肢）','周二·推（上肢）','周四·拉（上肢）','周五·综合补弱+体测'];
...
/* 阶段目标总览 */
const PHASE_TARGETS=[
  ['减脂·技术期','W1-16','减脂 + 动作打底（蹲/拉/推/髋铰链/爆发）+ 体测专项 + 肩宽启动','65-67kg / 12-14%','深蹲95-100 · 硬拉125-130 · 卧推90-95 · 引体+25-30 · 1000米≤4′25 · 肩围110-115'],
  ['增肌·力量期','W17-36','力量增长 + 肌肉量 + 肩宽推进 + 体能维持','71-73kg / 13-15%','深蹲125-135 · 硬拉155-165 · 卧推100-107 · 引体+35-40 · 1000米≤4′10 · 肩围115-120'],
  ['塑形·冲刺期','W37-46','再减脂到 12-13% + 力量/爆发峰值','70-72kg / 12-13%','深蹲130-140 · 硬拉165-170 · 卧推107-112 · 引体+40 · 1000米≤4′00 · 肩围118-122'],
];
...
const DAY_DURATION={0:{base:75,deload:65},1:{base:80,deload:70},2:{base:75,deload:65},3:{base:90,deload:80}};
...
function buildDay(wk,idx){
  ...
  const lists=[
    ...
    [
      ...
      ['实力推（轻快发力）','3×5',LOAD.pp[i]+'kg','全身发力模式；RIR 2-3，只做技术不过载',false,null],
    ...
    [
      ...
      ...(p===2
        ? [...(wk%2
            ? [['30-40m 冲刺（速度维持）','4×30-40m','自重','全速但量小；与1000米隔周交替',false,null]]
            : [['1000米节奏跑（体测·隔周）','1次','自重','70-75%用力；节奏稳定即可',false,null]]),
           ['10×4 折返跑（技术维持）','3组','自重','转身技术优先',false,null]]
...
function renderPlan(){
  ...
  const alloc=[
    ['减脂·技术期','W1-16','4练/周：蹲·推·拉·综合补弱','主项 5×5（减载 3×5）','中容量：每肌群约 8-12 组/周','周五综合日：1000米+10×4（体测专项）','按体重自动换算 · 蛋白 ~2.1g/kg'],
    ['增肌·力量期','W17-36','4练/周：蹲·推·拉·综合补弱','主项 5×5（减载 3×5）','高容量：每肌群约 12-18 组/周','周五：30m冲刺维持；1000米隔周','按体重自动换算 · 蛋白 ~2.1g/kg'],
    ['塑形·冲刺期','W37-46','4练/周：蹲·推·拉·综合补弱','主项 3×3-4，强度优先','低容量：每肌群约 8-12 组/周','周五：恢复1000米体测专项','按体重自动换算 · 蛋白 ~2.1g/kg'],
  ];
...
const EVIDENCE=[
  ...
  {cat:'力量与增肌（肌肉大且好用）',list:[
    ...
    {t:'每周训练容量与增肌剂量关系',s:'Schoenfeld 等 2017 · J Sports Sci（荟萃）',c:'每肌群每周 10+ 组有效训练，增肌收益随容量上升，但新手 6-8 组也有效。',u:'四天分化：胸/背/肩=主项日+周五综合补弱（每周 2 次刺激），腿=周一重主项+周五跳跃/体测；每肌群约 8-14 组/周。'},
    {t:'组间休息时长',s:'Grgic 等 2018 · Sports Med（荟萃）',c:'复合大重量动作组间休 3-5 分钟，力量收益优于短间歇。',u:'主项与跳跃/冲刺类统一休 3-5 分钟，辅助 60-90 秒，已写进每组的休息提示。'},
  ...
  {cat:'爆发力与运动表现（好用）',list:[
    {t:'力量是爆发力的基础',s:'Suchomel, Nimphius & Stone 2016 · Sports Med',c:'最大力量水平决定爆发力的天花板；先涨力量，爆发动作才有效。',u:'前 16 周（减脂·技术期）以深蹲硬拉打底，跳跃/冲刺只做技术，不冲重量。'},
    {t:'爆发力需要重负荷+快速动作结合',s:'Cormie, McGuigan & Newton 2011 · Sports Med',c:'纯重负荷或纯轻快速都无法最大化爆发力，两者结合最优。',u:'主项力量日（周一蹲/周二推/周四拉）与周五综合日的跳跃+体测分开安排，形成"重-快"组合。'},
