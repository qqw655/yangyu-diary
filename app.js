...
const DAY_ORDER = [1,2,4,5]; // 周一/周二/周四/周五
const DAY_NAMES = ['周一·蹲（下肢）','周二·推（上肢）','周四·拉（上肢）','周五·综合补弱'];
...
/* 阶段目标总览 */
const PHASE_TARGETS=[
  ['减脂·技术期','W1-16','减脂 + 动作打底（蹲/拉/推/髋铰链/爆发）+ 肩宽启动','65-67kg / 12-14%','深蹲95-100 · 硬拉125-130 · 卧推90-95 · 引体+25-30 · 肩围110-115'],
  ['增肌·力量期','W17-36','力量增长 + 肌肉量 + 肩宽推进','71-73kg / 13-15%','深蹲125-135 · 硬拉155-165 · 卧推100-107 · 引体+35-40 · 肩围115-120'],
  ['塑形·冲刺期','W37-46','再减脂到 12-13% + 力量/爆发峰值','70-72kg / 12-13%','深蹲130-140 · 硬拉165-170 · 卧推107-112 · 引体+40 · 肩围118-122'],
];
...
const DAY_DURATION={0:{base:75,deload:65},1:{base:70,deload:60},2:{base:75,deload:65},3:{base:85,deload:75}};
...
function buildDay(wk,idx){
  ...
  const lists=[
    ...
    [
      ...
      ['实力推（主项，空杆递增）',mr,LOAD.pp[i]+'kg','主项：'+rir+'；速度掉20%停组'+cond,true,'pp'],
      ['上斜哑铃卧推（上胸·弱区）','3×10-12','哑铃 10-15kg（自定）','弱区·上胸；RIR 2-3，严格控制',false,null],
      ['哑铃侧平举（中束·弱区）','3×15-20','哑铃（自定）','弱区·中束；RIR 2-3，不借力',false,null],
      ['俯身哑铃反向飞鸟（后束·弱区）','3×12-15','哑铃（自定）','弱区·后束；RIR 2-3，肩胛放松只动肩关节',false,null],
      ['宽握引体（背阔·弱区·轻容量）','3×8-10','自重或轻负重','弱区·背阔宽度；RIR 2-3，不摆荡',false,null],
...
function renderPlan(){
  ...
  const alloc=[
    ['减脂·技术期','W1-16','4练/周：蹲·推·拉·综合补弱','主项 5×5（减载 3×5）','中容量：每肌群约 8-12 组/周','周五：跳深/摸高（爆发保底）','按体重自动换算 · 蛋白 ~2.1g/kg'],
    ['增肌·力量期','W17-36','4练/周：蹲·推·拉·综合补弱','主项 5×5（减载 3×5）','高容量：每肌群约 12-18 组/周','周五：跳深/摸高（爆发保底）','按体重自动换算 · 蛋白 ~2.1g/kg'],
    ['塑形·冲刺期','W37-46','4练/周：蹲·推·拉·综合补弱','主项 3×3-4，强度优先','低容量：每肌群约 8-12 组/周','周五：跳深/摸高（爆发保底）','按体重自动换算 · 蛋白 ~2.1g/kg'],
  ];
...
const EVIDENCE=[
  ...
  {cat:'力量与增肌（肌肉大且好用）',list:[
    ...
    {t:'每周训练容量与增肌剂量关系',s:'Schoenfeld 等 2017 · J Sports Sci（荟萃）',c:'每肌群每周 10+ 组有效训练，增肌收益随容量上升，但新手 6-8 组也有效。',u:'四天分化：胸/背/肩=主项日+周五综合补弱（每周 2 次刺激），腿=周一重主项+周五跳跃；每肌群约 8-14 组/周。'},
    {t:'组间休息时长',s:'Grgic 等 2018 · Sports Med（荟萃）',c:'复合大重量动作组间休 3-5 分钟，力量收益优于短间歇。',u:'主项与跳跃类统一休 3-5 分钟，辅助 60-90 秒，已写进每组的休息提示。'},
    {t:'自然训练者的频率与容量',s:'Schoenfeld 等 2016 · J Sports Sci（频率荟萃）；Helms 等 2014 · JISSN',c:'自然训练者建议每肌群每周 2 次左右刺激、容量渐进，比单次练到瘫更有效。',u:'弱区（上胸/中束/后束/背阔）在主项日之外，周五综合日补第二次刺激；侧平举并入推日作为肩部发展的一部分。'},
  ]},
  {cat:'爆发力与运动表现（好用）',list:[
    ...
    {t:'爆发力需要重负荷+快速动作结合',s:'Cormie, McGuigan & Newton 2011 · Sports Med',c:'纯重负荷或纯轻快速都无法最大化爆发力，两者结合最优。',u:'主项力量日（周一蹲/周二推/周四拉）与周五综合日的跳跃分开安排，形成"重-快"组合。'},
    {t:'增强式训练提升弹跳',s:'Markovic 2007 · Br J Sports Med（荟萃）',c:'跳深、跳箱等增强式训练是提升垂直弹跳的有效手段。',u:'跳跃刺激集中在周五综合日（跳深/连续跳 + 摸高），速度优先、落地缓冲，与周一腿部力量日分日安排。'},
    {t:'增强式跳跃是可靠的爆发路径',s:'Tricoli 等 2005 · J Strength Cond Res',c:'短期内增强式跳跃能显著提升垂直跳与冲刺表现，不依赖复杂举重动作。',u:'周五综合日以跳深/连续跳 + 摸高承担爆发刺激，力量日同步打底，下肢爆发稳步提升。'},
  ]},
