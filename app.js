...
function buildDay(wk,idx){
  ...
  const lists=[
    ...
    [
      ...
      ['深蹲（轻容量·技术强化）','3×8-10',LOAD.squat[i]+'kg','轻重量高次数，打磨动作；RIR 2-3，不计入力量曲线',false,null],
...
const EVIDENCE=[
  ...
  {cat:'爆发力与运动表现（好用）',list:[
    ...
    {t:'髋铰链爆发动作（摆荡类）',s:'NSCA《体能训练精要》第4版（专著）',c:'壶铃/哑铃摆荡以髋部爆发伸髋为主，是速度-力量训练的有效功能性动作。',u:'蹲B以轻容量深蹲+硬拉打底，蹲A保留跳深/跳箱，髋部爆发由跳跃与农夫行走维持。'},
