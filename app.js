...
/* 阶段目标总览 */
const PHASE_TARGETS=[
  ['减脂·技术期','W1-16','减脂 + 动作打底（蹲/拉/推/髋铰链/爆发）+ 高翻空杆起步 + 肩宽启动','65-67kg / 12-14%','深蹲95-100 · 硬拉125-130 · 卧推90-95 · 引体+25-30 · 高翻入门35-45 · 肩围110-115'],
  ['增肌·力量期','W17-36','力量增长 + 肌肉量 + 高翻主项 + 肩宽推进','71-73kg / 13-15%','深蹲125-135 · 硬拉155-165 · 卧推100-107 · 引体+35-40 · 高翻60-75 · 肩围115-120'],
  ['塑形·冲刺期','W37-46','再减脂到 12-13% + 力量/爆发峰值','70-72kg / 12-13%','深蹲130-140 · 硬拉165-170 · 卧推107-112 · 引体+40 · 高翻80-90 · 肩围118-122'],
];
...
const EVIDENCE=[
  ...
  {cat:'爆发力与运动表现（好用）',list:[
    ...
    {t:'奥举动作是爆发力发展的重要工具',s:'Haff & Triplett《NSCA 体能训练精要》第4版（专著）',c:'高翻/高拉保留髋膝爆发 + 接杠稳定，是速度-力量训练的代表性动作。',u:'W3 起由高拉进阶高翻（空杆起步、轻技术优先）；无减震片时接住后控制下放，前蹲同步打底。'},
