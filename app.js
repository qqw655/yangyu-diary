...
const EVIDENCE=[
  ...
  {cat:'训练频率（一周练几次）',list:[
    {t:'每肌群每周练 2 次左右对增肌最优',s:'Schoenfeld, Grgic & Krieger 2019 · J Sports Sci（频率荟萃）',c:'同一肌肉 2-3 次/周比 1 次/周增肌效果略好；1 次仍有效但不是最优。',u:'对照你的计划：背/腿/肩已接近每周 2 次（周五拉+周四高翻、周一深蹲+周四前蹲、周二+周五肩），胸目前 1 次/周，是唯一低于文献最优档的肌群。'},
    ...
    {t:'力量最优=大重量+多组+每周 3 练；增肌最优=大重量+多组+每周 2 练',s:'Currier 等 2023 · Br J Sports Med（贝叶斯网络荟萃，178 项研究）',c:'所有处方都优于不练；力量排名最高的是大重量（≥80%1RM）+多组+每周 3 练，增肌排名最高的是大重量+多组+每周 2 练。',u:'主项全部走大重量+多组；增肌最优档是每肌群 2 次/周，你的背/腿/肩达标，胸差 1 次。'},
