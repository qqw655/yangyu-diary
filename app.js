...
function buildDay(wk,idx){
  ...
  const lists=[
    ...
    [
      ...
      ['上斜哑铃卧推（胸上束）','3×8-10',acc('15kg×2','17.5kg×2','20kg×2'),'辅项·胸每周第2次刺激（频率文献：每肌群2次/周最优）；RIR 2-3，8次轻松→+2.5kg',false,null],
...
const EVIDENCE=[
  ...
  {cat:'训练频率（一周练几次）',list:[
    {t:'每肌群每周练 2 次左右对增肌最优',s:'Schoenfeld, Grgic & Krieger 2019 · J Sports Sci（频率荟萃）',c:'同一肌肉 2-3 次/周比 1 次/周增肌效果略好；1 次仍有效但不是最优。',u:'胸/背/腿/肩按每周 2 次刺激排：胸=周二卧推+周五上斜，背=周五拉+周四高翻/高拉，腿=周一深蹲+周四前蹲，肩=周二+周五侧平举。'},
    {t:'等容量下 2 练和 4 练效果接近',s:'Johnsen & van den Tillaar 2022 · Front Physiol（RCT）',c:'每周总组数相同时，训练者一周 2 次与 4 次的增肌、力量增长无显著差异——频率不如容量与渐进重要。',u:'保持一周 4 练、每肌群 2 次；不为“更高频率”加天数而牺牲恢复。'},
    {t:'力量最优=大重量+多组+每周 3 练；增肌最优=大重量+多组+每周 2 练',s:'Currier 等 2023 · Br J Sports Med（贝叶斯网络荟萃，178 项研究）',c:'所有处方都优于不练；力量排名最高的是大重量（≥80%1RM）+多组+每周 3 练，增肌排名最高的是大重量+多组+每周 2 练。',u:'主项全部走大重量+多组；每肌群 2 次/周正是增肌最优档，减脂期恢复也更友好。'},
  ...
  {cat:'力量与增肌（肌肉大且好用）',list:[
    ...
    {t:'每周训练容量与增肌剂量关系',s:'Schoenfeld 等 2017 · J Sports Sci（荟萃）',c:'每肌群每周 10+ 组有效训练，增肌收益随容量上升，但新手 6-8 组也有效。',u:'四天分化：胸/背/腿/肩每周 2 次刺激（胸=周二卧推+周五上斜，背=周五拉+周四高翻，腿=周一深蹲+周四前蹲，肩=周二+周五侧平举），每肌群约 8-14 组/周，随阶段递增。'},
