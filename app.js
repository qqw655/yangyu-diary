...
const DAY_DURATION={0:{base:75,deload:65},1:{base:70,deload:60},2:{base:80,deload:70},3:{base:85,deload:75}};
...
const EVIDENCE=[
  ...
  {cat:'训练频率（一周练几次）',list:[
    {t:'每肌群每周练 2 次左右对增肌最优',s:'Schoenfeld, Grgic & Krieger 2019 · J Sports Sci（频率荟萃）',c:'同一肌肉 2-3 次/周比 1 次/周增肌效果略好；1 次仍有效但不是最优。',u:'对照你的计划：胸=周二卧推+双杠、周五双杠（2次/周），背=周五拉+周四高翻，腿=周一深蹲+周四前蹲，肩=周二+周五侧平举——全部踩在 2 次/周最优档。'},
    {t:'等容量下 2 练和 4 练效果接近',s:'Johnsen & van den Tillaar 2022 · Front Physiol（RCT）',c:'每周总组数相同时，训练者一周 2 次与 4 次的增肌、力量增长无显著差异——频率不如容量与渐进重要。',u:'保持一周 4 练的骨架；不必为“更高频率”加天数而牺牲恢复，重点是总容量与渐进。'},
    {t:'力量最优=大重量+多组+每周 3 练；增肌最优=大重量+多组+每周 2 练',s:'Currier 等 2023 · Br J Sports Med（贝叶斯网络荟萃，178 项研究）',c:'所有处方都优于不练；力量排名最高的是大重量（≥80%1RM）+多组+每周 3 练，增肌排名最高的是大重量+多组+每周 2 练。',u:'主项全部走大重量+多组；每肌群 2 次/周正是增肌最优档，胸已用双杠补到第 2 次。'},
    {t:'分散训练优于一次练完（下肢）',s:'Pedersen 等 2024 · Eur J Sport Sci（RCT）',c:'同等训练量下，下肢 4 个动作分散在 4 次课比集中在 1 次课，最大力量增长更多。',u:'腿的容量分散在周一（深蹲+硬拉）与周四（前蹲+RDL+跳跃），不一天练瘫。'},
  ]},
  ...
  {cat:'爆发力与运动表现（好用）',list:[
    ...
    {t:'奥举 vs 跳跃训练对下肢爆发的影响',s:'Tricoli 等 2005 · J Strength Cond Res',c:'短期奥举类（高翻）与跳跃训练均能显著提升垂直跳与冲刺表现。',u:'爆发日=高翻/高拉 + 跳箱/跳深组合，两种刺激并存，不偏科。'},
    {t:'爆发力还看力量发展速率（RFD）',s:'Maffiuletti 等 2016 · Eur J Appl Physiol（综述）',c:'运动表现不只看最大力量，还看从发力到峰值的时间；重负荷提升最大力量，快速发力动作提升早期发力速度，两条路径都要练。',u:'力量日保持 3-6RM 大重量，爆发日高翻/高拉+跳箱/跳深全速完成——重与快两种刺激并存。'},
    {t:'短冲刺是时间效率最高的体能补充',s:'Buchheit & Laursen 2013 · Sports Med（HIIT 编程综述）',c:'20-40m 短冲刺×4-6 次能同时提升无氧与有氧能力，每次仅需几分钟，适合久坐备考者。',u:'休息日可选全能体能已内置 4×30-40m 冲刺；备考期每周 1-2 次即可保底，不影响恢复。'},
  ]},
  {cat:'营养与身体成分（减脂/增肌/塑形）',list:[
    ...
    {t:'热量缺口下也能同时增肌减脂',s:'Longland 等 2016 · Am J Clin Nutr（RCT）',c:'高强度力量训练 + 高蛋白（2.4g/kg/天）+ 热量缺口时，训练者可以同时增加瘦体重、减少脂肪。',u:'减脂期蛋白 150g（≈2.1g/kg，接近文献 2.4g/kg）、主项强度不降（RIR 1-2）、缺口 300-400 大卡，正是这个配方。'},
    {t:'训练者减脂期增肌的前提条件',s:'Barakat 等 2020 · Strength Cond J（身体重组综述）',c:'训练者可以边减脂边增肌，前提是：蛋白充足、热量缺口温和、训练强度保持、睡眠充足。',u:'16 周减脂期按“保强度、保蛋白、小缺口”执行，目标体脂 12-14% 的同时保住甚至增长瘦体重。'},
