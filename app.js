...
const DAY_NAMES = ['周一·下肢力量','周二·上肢推力量','周四·爆发+体测','周五·上肢拉力量'];
...
const DAY_DURATION={0:{base:75,deload:65},1:{base:70,deload:60},2:{base:90,deload:80},3:{base:75,deload:65}};
...
function buildDay(wk,idx){
  ...
  const lists=[
    ...
    /* 周四 · 爆发+体测【中】 */
    [
      ['热身（动态+空杆深蹲递增）','8分钟','空杆','深蹲技术热身',false,null],
      ['深蹲（轻容量·技术强化）','3×8-10','周一深蹲的 70-80%','技术巩固，不冲极限；RIR 2-3，不计入力量曲线',false,null],
    ...
    [
      ...
      ['哑铃侧平举（中束·弱区）','3×12-15','哑铃（自定）','弱区·中束；RIR 2-3，不借力',false,null],
...
function renderPlan(){
  ...
  const alloc=[
    ['减脂·技术期','W1-16','4练/周（周一/二/四/五）','主项 5×5（减载 3×5）','中容量：每肌群约 8-12 组/周','周四1000米+10×4（体测专项）','按体重自动换算 · 蛋白 ~2.1g/kg'],
    ['增肌·力量期','W17-36','4练/周（周一/二/四/五）','主项 5×5（减载 3×5）','高容量：每肌群约 12-18 组/周','周四30m冲刺维持；1000米隔周','按体重自动换算 · 蛋白 ~2.1g/kg'],
    ['塑形·冲刺期','W37-46','4练/周（周一/二/四/五）','主项 3×3-4，强度优先','低容量：每肌群约 8-12 组/周','恢复1000米体测专项','按体重自动换算 · 蛋白 ~2.1g/kg'],
  ];
...
const EVIDENCE=[
  ...
  {cat:'爆发力与运动表现（好用）',list:[
    ...
    {t:'爆发力需要重负荷+快速动作结合',s:'Cormie, McGuigan & Newton 2011 · Sports Med',c:'纯重负荷或纯轻快速都无法最大化爆发力，两者结合最优。',u:'力量日（周一/周五大重量）与爆发/体测日（周四跳跃+跑步）分开安排，形成"重-快"组合。'},
    {t:'增强式训练提升弹跳',s:'Markovic 2007 · Br J Sports Med（荟萃）',c:'跳深、跳箱等增强式训练是提升垂直弹跳的有效手段。',u:'跳跃刺激集中在周四（跳深/连续跳 + 摸高），速度优先、落地缓冲，与腿部力量日分日安排。'},
    {t:'增强式跳跃是可靠的爆发路径',s:'Tricoli 等 2005 · J Strength Cond Res',c:'短期内增强式跳跃能显著提升垂直跳与冲刺表现，不依赖复杂举重动作。',u:'周四以跳深/连续跳 + 摸高承担爆发刺激，力量日同步打底，下肢爆发稳步提升。'},
  ]},
